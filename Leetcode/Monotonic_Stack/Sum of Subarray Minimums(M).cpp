...
// Left array contains next lesser element in the left and right array contains next lesser element in the right
//every elements contribution is left[i] * right[i] 
